# CAREERLAUNCH: JOB INSIGHT & FRAUD DETECTION SYSTEM
## A Comprehensive Web Platform for Skill Gap Analysis, Role Matching & Employment Scam Protection for Freshers
...
This is to certify that the project entitled **"CAREERLAUNCH: JOB INSIGHT & FRAUD DETECTION SYSTEM"** is a bona fide work done by **SRISHTI** in partial fulfillment of the requirements for the degree of Bachelor of Technology in Computer Science & Engineering.
...
**CareerLaunch** is an all-in-one client-side web application engineered specifically for Indian CS/IT students. It features:
...
5. **Fake Job Scam Detector**: Evaluates job links and descriptions using 30 verified domain rules and 20 security regex patterns.
...
| **8** | Chapter 6: System Screenshots & Module Walkthrough |
| **9** | Chapter 7: System Testing & Test Case Suite |
| **10** | Chapter 8: Conclusion & Future Scope |
| **11** | Chapter 9: Complete Source Code Listings (HTML, CSS, JS) |
...
- **Internshala:** Excellent for internships, but limited in full-time role matching or resume scoring.
...
## 10. CHAPTER 6: SYSTEM SCREENSHOTS & MODULE WALKTHROUGH

### 6.1 Hero & Dashboard Module
...
### 6.2 Dashboard Analytics & Health Gauge
![Dashboard Analytics](image_131.jpg)
*Figure 6.2: Overview dashboard presenting overall resume fitness gauge and key metric cards.*

### 6.3 Resume Parsing & Categorized Skill Extractor
![Resume Skill Extraction](image_resume_analysis.jpg)
*Figure 6.3: Resume Parsing output showing extracted skills categorized into Languages, Frameworks, Databases, and Cloud.*

### 6.4 Skill Gap Analysis & Resource Center
![Skill Gap Analysis](image_skill_gap.jpg)
*Figure 6.4: Skill Gap Analysis page identifying missing skills per role with direct links to freeCodeCamp and LeetCode.*

### 6.5 Job Role Matching Engine
![Job Role Matching](image_13.jpg)
*Figure 6.5: Job Role Matcher displaying circular SVG compatibility rings and salary expectations in India.*

### 6.6 Real-Time Opportunities Aggregator
![Real-Time Jobs](image_14.jpg)
*Figure 6.6: Real-time India job listings and internship postings fetched from JSearch API.*

### 6.7 Fake Job Scam Detector
![Fake Job Detector](image_15_scam.jpg)
*Figure 6.7: Fake Job Scam Detector analyzing a job posting and identifying upfront fee red flags.*

### 6.8 Mobile Responsive View & Drawer
![Mobile Layout](image12.jpg)
*Figure 6.8: Mobile responsive navigation drawer and touch-friendly interface layout.*
...
| **TC-08** | LaTeX Generator | Click 'Download PDF' | Formatted PDF generated & downloaded | **PASS** |
| **TC-09** | Supabase Sync | Resume parsed | Analysis stored in Supabase Cloud DB | **PASS** |
...
2. **Automated Resume Tailoring:** Auto-rewriting resumes to match specific job descriptions.
3. **Interactive Mock Practice:** Simulating technical interviews with real-time feedback.
...
3. **Mozilla PDF.js Library Documentation.** [mozilla.github.io/pdf.js](https://mozilla.github.io/pdf.js/)
4. **Supabase JavaScript Client v2.** [supabase.com/docs](https://supabase.com/docs)
5. **Chart.js Documentation.** [www.chartjs.org](https://www.chartjs.org/)
